...
These projects were built using PyCharm, a professional Python IDE. Do note that certain programs require you to import libraries by installing them using the terminal (indicated at the start of each program file). The entire repository can be downloaded by downloading the .rar file from the download folder. Below are documents which provide information on how to set up PyCharm and how to use Karel in PyCharm:
